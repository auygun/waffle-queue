    ...
    <table class="fixed_thead">
      <thead>
        <tr>
          <th style="width: 0rem;">
            <div class="center">
              <span v-if="!allExpanded" @click="expandAll(true)" class="material-icons"
                style="cursor:default;">unfold_more</span>
              <span v-if="allExpanded" @click="expandAll(false)" class="material-icons"
                style="cursor:default;">unfold_less</span>
            </div>
          </th>
      ...
      <tbody>
        <tr v-for="(r, index) in rows" :key="index" :style="{ 'background-color': r.bgColor }">
          <td v-if="!r.isDetail">
            <div class="center">
              <span v-if="!r.expanded" @click="onToggleExpand(index)" class="material-icons"
                style="cursor:default;">expand_more</span>
              <span v-if="r.expanded" @click="onToggleExpand(index)" class="material-icons"
                style="cursor:default;">expand_less</span>
            </div>
          </td>
